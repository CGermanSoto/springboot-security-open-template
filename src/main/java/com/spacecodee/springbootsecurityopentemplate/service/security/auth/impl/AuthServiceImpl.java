...
public class AuthServiceImpl implements IAuthService {
    ...
    public AuthResponseDTO login(@NotNull LoginVO loginVO) {
        try {
            ...
            if (existingToken != null) {
                ...
                this.handleTokenLifecycle(refreshedToken.getToken(), user.getUsername(), "refresh");
            ...
            this.handleTokenLifecycle(newToken.getToken(), user.getUsername(), "new");
     ...
     */
    private void handleTokenLifecycle(String token, String username, String operationType) {
        try {
            if ("new".equals(operationType)) {
                ...
                this.tokenLifecycleService.refreshToken(token, token);
            }
        } catch (Exception e) {
